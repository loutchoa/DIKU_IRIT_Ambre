...
% Img 2 Dioptre
[Masques_Imgs_Projections_Pts_Dioptres, Imgs_2_Dioptres, Dioptres_2_Imgs] = Calculer_Imgs_2_Dioptres(camera.visiblePoints, camera.R, camera.t, camera.K, Masques_Imgs) ;
