...
function [Masques_Imgs_Projections_Pts_Dioptres, Imgs_2_Dioptres, Dioptres_2_Imgs, usedDiopterPoints] = Calculer_Imgs_2_Dioptres(Pts_Dioptres, camera, Masques_Imgs)
    ...
    for i = 1:Nb_Imgs
        ...
        %Distances2Diopter{i} = Distances2Diopter_i;
